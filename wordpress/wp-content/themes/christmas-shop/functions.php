...
//define theme version
if ( !defined( 'CHRISTMAS_SHOP_THEME_NAME' ) ) {
	$theme_data = wp_get_theme();
	
	define ( 'CHRISTMAS_SHOP_THEME_NAME', $theme_data->get( 'Name' ) );
}

//define theme version
if ( !defined( 'CHRISTMAS_SHOP_THEME_TEXTDOMAIN' ) ) {
	$theme_data = wp_get_theme();
	
	define ( 'CHRISTMAS_SHOP_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
}
