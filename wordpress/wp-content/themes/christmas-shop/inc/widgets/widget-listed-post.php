...
// register Christmas_Shop_Listed_Post widget
function christmas_shop_register_listed_post_widget() {
    register_widget( 'Christmas_Shop_Listed_Post' );
}
add_action( 'widgets_init', 'christmas_shop_register_listed_post_widget' );
 
 /**
 * Adds Christmas_Shop_Listed_Post widget.
 */
class Christmas_Shop_Listed_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'christmas_shop_listed_post', // Base ID
			esc_html__( 'PROSYS: Listed Post', 'christmas-shop' ), // Name
			array( 'description' => esc_html__( 'A Listed Post Widget', 'christmas-shop' ), ) // Args
		);
	}
                    ...
                    <li>
                        <?php if( has_post_thumbnail() && $show_thumb ){ ?>
                            <a href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php the_post_thumbnail( 'christmas-shop-listed-post' );?>
                            </a>
                        <?php }?>
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'num_post' ) ); ?>"><?php esc_html_e( 'Number of Posts', 'christmas-shop' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_thumbnail' ) ); ?>"><?php esc_html_e( 'Show Post Thumbnail', 'christmas-shop' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_postdate' ) ); ?>"><?php esc_html_e( 'Show Post Date', 'christmas-shop' ); ?></label>
		</p>

        <p> 
            <label for="<?php echo esc_attr( $this->get_field_id( 'listed_type' ) ); ?>"><?php esc_html_e( 'Listed As', 'christmas-shop' ); ?></label>
            <input id="<?php echo esc_attr( $this->get_field_name( 'listed_type' ) ); ?>" type="radio" name="<?php echo esc_attr( $this->get_field_name( 'listed_type' ) ); ?>" value="<?php echo esc_attr( 'recent' ); ?>" <?php checked( 'recent', $listed_type ); ?> ><?php _e( 'Recent', 'christmas-shop' ); ?>
            <input id="<?php echo esc_attr( $this->get_field_name( 'listed_type' ) ); ?>" type="radio" name="<?php echo esc_attr( $this->get_field_name( 'listed_type' ) ); ?>" value="<?php echo esc_attr( 'popular' ); ?>" <?php checked( 'popular', $listed_type ); ?> ><?php _e( 'Popular', 'christmas-shop' ); ?>
        </p>
...
} // class Christmas_Shop_Listed_Post 